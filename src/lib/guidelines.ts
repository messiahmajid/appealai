...
export interface Guideline {
    ...
    relevantCptCodes: string[];
    relevantIcd10Codes: string[];
}

export const MEDICAL_GUIDELINES: Guideline[] = [
    // ===== ADVANCED IMAGING =====
    {
        id: 'cms-ncd-220.1',
...
CT alone has limited sensitivity for mediastinal lymph node staging in lung cancer (sensitivity 51-65%, specificity 74-85%), which is substantially inferior to PET/CT. See CMS NCD 220.6 and NCCN NSCLC guidelines for appropriate use of PET/CT in oncologic staging.`,
        ...
        relevantCptCodes: ['70450', '70460', '70470', '71250', '71260', '71270', '72125', '72126', '72127', '74150', '74160', '74170', '74176', '74177', '74178'],
        relevantIcd10Codes: ['R10.9', 'R07.9', 'R51.9', 'S06.9', 'I26.99', 'C34.90'],
    },
    {
        id: 'cms-ncd-220.2',
...
- MRI detects clinically significant prostate cancer (Gleason ≥7) with sensitivity 91%, specificity 37% on PI-RADS v2 (Kasivisvanathan et al., PRECISION trial, NEJM 2018)`,
        ...
        relevantCptCodes: ['70551', '70552', '70553', '72141', '72142', '72146', '72147', '72148', '72149', '72156', '72157', '73221', '73222', '73223', '73721', '73722', '73723'],
        relevantIcd10Codes: ['M54.5', 'M17.0', 'M23.20', 'G35', 'M79.3', 'M87.9'],
    },
    {
        id: 'cms-ncd-220.6',
...
4. How PET results will change the treatment plan`,
        ...
        relevantCptCodes: ['78811', '78812', '78813', '78814', '78815', '78816'],
        relevantIcd10Codes: ['C34.90', 'C34.10', 'C34.11', 'C34.12', 'C18.9', 'C81.90', 'C83.90', 'C43.9', 'C50.911'],
    },
...
- Medical clearance documentation`,
        ...
        relevantCptCodes: ['27447', '27446', '27486', '27487'],
        relevantIcd10Codes: ['M17.0', 'M17.10', 'M17.11', 'M17.12', 'M17.9', 'M06.9'],
    },
    {
        id: 'lcd-l35077',
...
- Prior surgical history if applicable`,
        ...
        relevantCptCodes: ['22551', '22554', '22558', '22612', '22630', '22633', '22634', '22853', '22854'],
        relevantIcd10Codes: ['M43.16', 'M43.06', 'M51.16', 'M51.17', 'M47.816', 'M47.817', 'M48.06', 'M96.1'],
    },
...
- For stable disease: documentation of why PCI is appropriate given COURAGE/ISCHEMIA evidence (e.g., refractory symptoms despite OMT, anatomy not suited for conservative management)`,
        ...
        relevantCptCodes: ['93451', '93452', '93453', '93454', '93455', '93456', '93457', '93458', '93459', '92920', '92921', '92924', '92928', '92929'],
        relevantIcd10Codes: ['I25.10', 'I25.110', 'I25.5', 'I20.0', 'I20.9', 'I21.9', 'I21.01', 'I21.11', 'I21.4'],
    },
...
- Cost-effective: avoidance of futile surgery saves $20,000-40,000 per avoided thoracotomy; PET staging is cost-effective at $25,000-30,000 per QALY (Alzahouri et al., J Clin Oncol 2005)`,
        ...
        relevantCptCodes: ['78816', '70553', '71260', '88305', '81235', '81401', '81479'],
        relevantIcd10Codes: ['C34.90', 'C34.10', 'C34.11', 'C34.12', 'C34.30', 'C34.31', 'C34.32', 'C34.80', 'C34.81', 'C34.82', 'R91.1'],
    },
...
- ACR/EULAR 2015 recommendations: continue biologic if patient achieves at least low disease activity (DAS28 ≤3.2 or CDAI ≤10); consider tapering only if sustained remission (DAS28 <2.6) for ≥6 months`,
        ...
        relevantCptCodes: ['96365', '96366', '96367', '96372', 'J0135', 'J1745', 'J3262'],
        relevantIcd10Codes: ['M05.79', 'M06.09', 'M06.9', 'M05.70', 'M06.00'],
    },
...
7. Date of physician signature`,
        ...
        relevantCptCodes: ['K0856', 'K0857', 'K0858', 'K0859', 'K0860', 'K0861', 'K0862', 'K0863', 'K0864', 'K0800', 'K0801'],
        relevantIcd10Codes: ['G35', 'G80.9', 'G82.20', 'G82.50', 'M62.81', 'G12.21', 'G71.0'],
    },
...
- Lab work including thyroid function, cortisol, HbA1c`,
        ...
        relevantCptCodes: ['43644', '43645', '43770', '43771', '43772', '43773', '43774', '43775', '43842', '43843', '43846', '43847'],
        relevantIcd10Codes: ['E66.01', 'E66.09', 'E11.9', 'G47.33', 'I10', 'E66.2'],
    },
    {
        id: 'lcd-sleep-study',
...
- Cost-effectiveness: Diagnosis and treatment of moderate-to-severe OSA with CPAP is cost-effective at $3,000-13,000 per QALY gained (Ayas et al., Ann Intern Med 2006).`,
        ...
        relevantCptCodes: ['95810', '95811', '95800', '95801', '95806', 'E0601', 'E0470', 'E0471'],
        relevantIcd10Codes: ['G47.33', 'G47.30', 'G47.39', 'R06.83', 'G47.9'],
    },
    // ===== SPECIALTY PHARMACY / DIABETES =====
    {
...
- Statement that drug is requested for type 2 diabetes/glycemic control`,
        ...
        relevantCptCodes: ['MOUNJARO', 'TIRZEPATIDE', 'OZEMPIC', 'SEMAGLUTIDE', 'TRULICITY', 'DULAGLUTIDE', 'VICTOZA', 'LIRAGLUTIDE'],
        relevantIcd10Codes: ['E11.65', 'E11.9', 'E11.22', 'E11.42', 'E11.69', 'E66.9', 'Z79.4'],
    },
    // ===== ADDITIONAL ORTHOPEDIC / PAIN MANAGEMENT =====
    {
        id: 'lcd-l34163-tha',
...
- Surgical plan and medical optimization/clearance when applicable`,
        ...
        relevantCptCodes: ['27130', '27132', '27134', '27137', '27138'],
        relevantIcd10Codes: ['M16.0', 'M16.10', 'M16.11', 'M16.12', 'M87.051', 'M87.052', 'S72.001A', 'S72.002A'],
    },
    {
        id: 'lcd-l39054-esi',
...
- Functional impact and treatment goal`,
        ...
        relevantCptCodes: ['62320', '62321', '62322', '62323', '64479', '64480', '64483', '64484'],
        relevantIcd10Codes: ['M54.16', 'M54.12', 'M54.14', 'M48.062', 'M48.061', 'M51.16', 'M50.10'],
    },
    // ===== ONCOLOGY DRUGS =====
    {
...
- Guideline or compendium support for off-label use`,
        ...
        relevantCptCodes: ['J9271', 'J9299', 'J9228', 'J9355', 'J9354', 'J9306', 'J9173', 'J9022', 'J9312', 'J9035'],
        relevantIcd10Codes: ['C34.90', 'C50.911', 'C50.912', 'C18.9', 'C19', 'C20', 'C43.9', 'C81.90', 'C83.30'],
    },
    // ===== DME / RESPIRATORY =====
    {
...
- Reassessment or continued need documentation when required`,
        ...
        relevantCptCodes: ['E1390', 'E1392', 'E0431', 'E0433', 'E0434', 'E0435', 'E0443', 'E0444'],
        relevantIcd10Codes: ['J44.9', 'J96.11', 'J96.10', 'R09.02', 'I27.20', 'I50.9', 'D75.1'],
    },
    {
...
- Detailed written order and supplier documentation`,
        ...
        relevantCptCodes: ['K0001', 'K0003', 'K0004', 'K0005', 'K0823', 'K0825', 'K0835', 'K0848', 'E1028', 'E2365'],
        relevantIcd10Codes: ['R26.2', 'R26.89', 'Z74.09', 'G20', 'G35', 'I69.351', 'M17.0', 'M48.061'],
    },
];
...
export function searchGuidelines(query: string): Guideline[] {
    ...
    return MEDICAL_GUIDELINES.filter(g => {
        const searchText = `${g.title} ${g.content} ${g.category} ${g.relevantCptCodes.join(' ')} ${g.relevantIcd10Codes.join(' ')}`.toLowerCase();
...
export function getGuidelinesByCode(code: string): Guideline[] {
    ...
    return MEDICAL_GUIDELINES.filter(g => {
        ...
        return allCodes.some(c => c.includes(normalized) || normalized.includes(c));
    });
}
...
export function getGuidelineChunks(): { id: string; text: string; guidelineId: string; title: string; source: string }[] {
    const chunks: { id: string; text: string; guidelineId: string; title: string; source: string }[] = [];
    ...
    for (const g of MEDICAL_GUIDELINES) {
        ...
        for (const para of paragraphs) {
            if (currentChunk.length + para.length > 600 && currentChunk.length > 100) {
                chunks.push({
                    id: `${g.id}-chunk-${chunkIndex}`,
        ...
        chunks.push({
            id: `${g.id}-criteria`,
            text: `[${g.title}] [Source: ${g.source}]\nApproval Criteria:\n${g.approvalCriteria.map((c, i) => `${i + 1}. ${c}`).join('\n')}\n\nRelevant CPT Codes: ${g.relevantCptCodes.join(', ')}\nRelevant ICD-10 Codes: ${g.relevantIcd10Codes.join(', ')}`,
            guidelineId: g.id,
            title: g.title,
            source: g.source,
        });
