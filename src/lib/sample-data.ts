/**
 * Realistic synthetic patient data — Synthea-quality clinical cases
 * for testing the appeal generation pipeline.
 */
...
export const SAMPLE_CASES: SampleCase[] = [
    {
        ...
        clinicalNotes: `OFFICE VISIT — ORTHOPEDIC SURGERY
Date: 01/15/2026
...
NPI: 1234567890`,
        ...
        denialReason: 'Insufficient documentation of conservative management. Medical records do not adequately demonstrate failure of conservative treatment modalities prior to surgical intervention. Please resubmit with complete documentation of conservative treatment attempts including dates, duration, and specific outcomes.',
    ...
    },
    {
        ...
        clinicalNotes: `CARDIOLOGY CONSULTATION NOTE
Date: 02/01/2026
...
NPI: 9876543210`,
        ...
        denialReason: 'The requested procedure is not medically necessary. Stress testing results do not meet criteria for invasive cardiac catheterization. Recommend continued medical management and repeat non-invasive testing in 3-6 months.',
        deniedService: 'Left Heart Catheterization with Coronary Angiography and Left Ventriculography',
        cptCodes: '93458',
        icd10Codes: 'I20.9, I25.10',
        physicianName: 'Dr. James Chen, MD, FACC',
        physicianNPI: '9876543210',
        practiceName: 'Heart & Vascular Institute of Northern Virginia',
    },
    {
        id: 'sample-onc-pet',
        ...
        clinicalNotes: `ONCOLOGY CONSULTATION NOTE
Date: 02/10/2026
...
NPI: 5678901234`,
        ...
        denialReason: 'The requested PET/CT scan is considered experimental/investigational for this indication. Clinical evidence does not support the use of PET imaging for this diagnosis. Standard CT imaging is sufficient for staging purposes.',
